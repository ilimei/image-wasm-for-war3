...
int encode_jpeg(unsigned char* rgba_buffer, unsigned int rgba_width, unsigned int rgba_height, int components, int quality, unsigned char** out_buffer, unsigned int* out_size, char** out_msg);
...
int encode_image(unsigned char* rgba_buffer, unsigned int rgb_width, unsigned int rgb_height, unsigned int type, unsigned char **out_buffer, unsigned int *out_size, char **out_msg);
